 ...
 * Override runChecks.
 */
public abstract class ReportingMatcherImpl<T> extends BaseMatcher<T> implements ReportingMatcher<T> {
    @NotNull private final Class<? super T> tClass;
    private ExecutedCompositeCheck lastReport = null;

    protected ReportingMatcherImpl() {
        this(Object.class);
    }

    protected ReportingMatcherImpl(@NotNull Class<? super T> tClass) {
        this.tClass = tClass;
    }
